...
%> 
    ...
    <span item-right><a href="deletestudymaterial.jsp?sid=<%=rs.getString(1) %>&cid=<%=cid %>" onclick="checkdelete();"><svg style="float:right;"" xmlns="http://www.w3.org/2000/svg" width="25" height="27" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
