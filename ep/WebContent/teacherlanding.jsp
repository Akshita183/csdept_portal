...
<head>
  ...
  <link href="css/course11.css" rel="stylesheet">
...
<div class="containercourse">
  ...
  try{
	  ...
	  Connection con=ConnectionProvider.getcon();
		...
		ResultSet rs=st1.executeQuery("select * from course where temail= '"+email+"'");
		int count=0;
		if(valu!=null)
		{
			if(valu.equals("AZ"))
			{
				rs=st1.executeQuery("select * from course where temail= '"+email+"' order by cname");
			}
			if(valu.equals("ZA"))
			{
				rs=st1.executeQuery("select * from course where temail= '"+email+"' order by cname DESC");
			}
		}
		while(rs.next())
		{ 
	%>
                ...
                %>
                  ...
                  <div class="metrics">
                    <div class="rat">
                      <i class="fa fa-star-o" aria-hidden="true"></i> <%= rs.getString(7) %>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-header">
            <span class="A"><a href="viewstudymat_t.jsp?cid=<%= rs.getInt(1) %>"><i class="fa fa-book fa-2x" aria-hidden="true"></i></a></span>
  ...
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
          ...
          <div class="modal-footer">
            ...
            <a href="addstudymat.jsp?cid=<%= rs.getInt(1) %>"><button type="button" class="btn btn-primary">Add Study Material</button></a>
            <% }
            else
            {
            %>
 ...
 <%
  ...
  %>
        ...
        <div class="category"></div>
         <div class="btn-right">
         <a href="addcourse.jsp"> <button type="button" class="btn btn-dark btn-lg">ADD COURSE</button></a>
         </div>
         </div>
...
<script>
    $(function() {
        $("#navbar").load("navbarcourse_t.jsp");
