...
<div id="navbarcourse">
		...
		if(search!=null)
		{
			ResultSet rs=st1.executeQuery("select * from course where cname like '%"+search+"%' AND category='Subject Course' ");
			
			if(valu!=null)
			{
				if(valu.equals("AZ"))
				{
					rs=st1.executeQuery("select * from course where cname like '%"+search+"%' AND category='Subject Course' order by cname");
				}
				if(valu.equals("ZA"))
				{
					rs=st1.executeQuery("select * from course where cname like '%"+search+"%' AND category='Subject Course' order by cname DESC");
				}
			}
...
<div class="category">Subject Course</div>
		...
		if(sea==0)
		{
			%><h1 style="color:white">No Subject Course Found!</h1>
...
<!--  Custom Scripts --> 
    ...
    $(function() {
        ...
        $("#navbarcourse").load("navbarsubsearch.jsp");
