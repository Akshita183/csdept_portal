...
<div class="box"> 
        ...
        <form action="timetableactionstudent.jsp?mssg=<%= value %>" method="post">
        ...
        <a class="btn btn-primary" id="r" onclick="func2()" href="deletetimetable_s.jsp?mssg=<%= value %>">Delete timetable</a>
        </div>
        </form>    
        <% } %>
        <br>
