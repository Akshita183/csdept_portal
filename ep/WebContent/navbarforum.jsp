...
<head>
    ...
    <link rel="stylesheet" href="css/navbarforumstyle.css">
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
     <ul class="nav sidebar-nav">
       ...
       <li class="dropdown">
       <a href="studentlanding.jsp" class="dropdown-toggle"  data-toggle="dropdown">Courses <span class="caret"></span></a>
            ...
            <button type="button" class="hamburger animated fadeInLeft is-closed" data-toggle="offcanvas">
				...
				<span class="hamb-bottom"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="ask">
                				<input type="button" class="Button" value="Ask Question" onclick='window.open("addques.jsp")'>  
        				</div>
