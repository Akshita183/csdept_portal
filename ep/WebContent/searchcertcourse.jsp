...
<head>
    ...
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.4/css/tether.min.css'>
     <link rel="stylesheet" href="css/course10.css">
...
<div id="wrapper">
    <div id="navbarcourse">
		...
		if(search!=null)
		{
			ResultSet rs=st1.executeQuery("select * from course where cname like '%"+search+"%' and category='Certificate Course'");
			
			if(valu!=null)
			{
				if(valu.equals("AZ"))
				{
					rs=st1.executeQuery("select * from course where cname like '%"+search+"%' and category='Certificate Course' order by cname");
				}
				if(valu.equals("ZA"))
				{
					rs=st1.executeQuery("select * from course where cname like '%"+search+"%' and category='Certificate Course' order by cname DESC");
				}
			}
...
<div class="category">Certificate Course</div>
		...
		if(sea==0)
		{
			%><h1 style="color:white">No Certificate Course Found!</h1>
...
<!--  Custom Scripts --> 
    ...
    $(function() {
        ...
        $("#navbarcourse").load("navbarcourse.jsp");
