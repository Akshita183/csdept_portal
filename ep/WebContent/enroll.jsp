...
<% }
	...
	if("valid".equals(msg)){
                %>
	<h1>Course Added to Enrolled Courses!</h1>
	<% }
	}
    %>
	<div class="containercourse">
		...
		ResultSet rs=st1.executeQuery("select * from enroll where email='"+email+"'");
				int zii=0;
		while(rs.next())
		{ 
			zii=zii+1;
		...
		<div class="course">
			...
			<div class="metrics">
				...
				<div class="C" onclick="location.href ='enrolldelete.jsp?mssg=<%=rs.getString(2)%>' ">
