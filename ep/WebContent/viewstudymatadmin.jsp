...
String mess=request.getParameter("mess");
  if(mess!=null)
  { %>
	  <h3 class="alert alert-danger" width="300px">Study Material Added Successfully!</h3>
	  <%
  }
  %>
  <img src="filestuff/courseimages/<%= rs1.getString(4) %>" class="card-img" alt="..." width="300px" height="200px">
...
%> 
    ...
    <span item-right><a href="deletestudymaterialadmin.jsp?sid=<%=rs.getString(1) %> &cid=<%=cid %>" onclick="checkdelete();"><svg style="float:right;"" xmlns="http://www.w3.org/2000/svg" width="25" height="27" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
