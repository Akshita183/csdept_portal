...
<div class="panel">
		...
		<div class="form">
		<form action="forgotpasswordaction_s.jsp" method="post">
			<input type="email" name="email" placeholder="Enter Email" required>
			<select name="sec_ques">
				<option value="What is the name of your first pet?">What is the name of your first pet?</option>
				<option value="What is your birthday month?">What elementary school did you attend?</option>
		...
		<br>
		<h2>Back to&nbsp;&nbsp;&nbsp;&nbsp;<a href="loginstudent.jsp">SIGN IN</a></h2>
		<div >
		<br>
