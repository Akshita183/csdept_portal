...
<div class="col-md-3"></div>
	<div class="col-md-6">
	<div class="row" style="margin-top: 30px; margin-right:-20px; box-shadow: -1px 1px 10px 10px #07294d;">
		<div class="col-md-6">
			<h1 class="text-center" style="border-bottom: 3px solid #07294d;">SIGN IN</h1>
			<form action="loginactionadmin.jsp" method="post">
			...
			<div>
  			...
  			{%> <h3 class="text-center">Incorrect Details! Try Again</h3>
			<%} %>
			</div>
		</div>
		<div class="col-md-6">
