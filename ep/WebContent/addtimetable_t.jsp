...
{
	%>
	<h1 style="color:white">Can't add! Teacher already exists</h1>
	<%
}
else if(msg.equals("valid")){
	%>
	<h1 style="color:white">Teacher's Timetable added successfully!</h1>
	<%
}
}
%>
...
<span>Add unregistered teacher's timetable</span>
</div>
<div class="ra">
<input type="radio" name="tab" value="igottwo" onclick="show2()">
<span>Add registered teacher's timetable</span>
</div>
<form action="addtimetableaction_t.jsp" id="sel" method="post">
<div id="a">
<label class="label control-label">Enter teacher's name: </label>
<input type="text" class="form-control" name="add" id="add"></input>
</div>

<select class ="select-css" name="valu" id="ddlViewBy">
<option value="" disabled selected hidden>Select teacher's name</option>
   <%
       Connection con=ConnectionProvider.getcon();
       Statement st=con.createStatement();
       ResultSet rs1=st.executeQuery("select name from teacher");
       while(rs1.next())
       {
       %>
...
function func2()
{
	...
	if(add.value =="" && e.value=="" && w0.value == "" && w1.value == "" && w2.value == "" && w3.value == "" && w4.value == "" && thur0.value == "" && thur1.value == "" && thur2.value == "" && thur3.value == "" && thur4.value == "" && fri0.value == "" && fri1.value == "" && fri2.value == "" && fri3.value == "" && fri4.value == "" && sat0.value == "" && sat1.value == "" && sat2.value == "" && sat3.value == "" && sat4.value == "" && sun0.value == "" && sun1.value == "" && sun2.value == "" && sun3.value == "" && sun4.value == "" && mon0.value == "" && mon1.value == "" && mon2.value == "" && mon3.value == "" && mon4.value == "")
    {
		alert("CAN'T ADD\nTeacher's name not entered!\nNo records entered!");
    }
	else if(add.value !="" && e.value!="")
    {
		alert("CAN'T ADD\n Enter only 1 teacher's name");
    }
	
	else if(add.value =="" && e.value=="")
	{
		alert("CAN'T ADD\nNo Teacher's name entered!");
	}
