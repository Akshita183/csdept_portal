...
/**
 * Servlet implementation class StudyMaterialAdmin
 */
@WebServlet("/StudyMaterialAdmin")
@MultipartConfig
public class StudyMaterialAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudyMaterialAdmin() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
    {
    	...
    	PrintWriter out= response.getWriter();
    		...
    		try
    		{
    			...
    			ps.executeUpdate();
    			response.sendRedirect("admincourse.jsp?msg=done");
    			
    		}
    		catch(Exception e)
    		{
    			
    			response.sendRedirect("addstudymatadmin.jsp?msg=wrong");
    		}
